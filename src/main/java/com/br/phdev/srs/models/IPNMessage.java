...
public class IPNMessage {
     ...
     *
     * @param request {@link HttpServletRequest} object received from PayPal IPN
     * call back.
     */
     ...
     * values.
     *
     * @param ipnMap {@link Map} representing IPN name/value pair
     *
     ...
     * @param request {@link HttpServletRequest} object received from PayPal IPN
     * call back.
     * @param configurationMap custom configuration {@link Map}
     *
     * @param decoded boolean Representing if the value has been decoded
     */
    public IPNMessage(HttpServletRequest request,
