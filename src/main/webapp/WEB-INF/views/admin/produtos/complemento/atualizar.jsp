                ...
                <div class="card col-md-12 col-sm-12 p-4">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <models:campoTexto id="fld_nome" name="nome" label="Nome" value="${complemento.nome}"/>
                        </div>
                    </div>                    
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <span id="msg_preco" class="text-danger"></span>
                            <models:campoPreco id="fld_preco" name="preco" label="Preço" value="${complemento.preco}"/>
                        </div>
                    </div>                    
                </div>
            </div>            
...
<script type="text/javascript">
    ...
    const id_complemento = "${complemento.id}";
    ...
    function verifica_dados() {
        ...
        if (ok) {
            ...
            formData.append("id", id_complemento);
        ...
        $.ajax({
            ...
            success: function (dadosIn) {
                ...
                switch (mensagem.codigo) {
                    case 100:
                        alertar("success", "Complemento cadastrado com sucesso");
                        limparCampos();
                        break;
                    default :
                        alertar("danger", "Erro ao cadastrar o complemento");
                        break;
                }
